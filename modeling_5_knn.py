...
def model(features, labels):
    ...
    scores = []
    for name, clf in [('K Nearest Neighbors (K = 2)', knn_2),
                      ('K Nearest Neighbors (K = 3)', knn_3),
                      ('K Nearest Neighbors (K = 4)', knn_4),
                      ('K Nearest Neighbors (K = 5)', knn_5),
                      ('K Nearest Neighbors (K = 6)', knn_6),
                      ('K Nearest Neighbors (K = 7)', knn_7),
                      ('K Nearest Neighbors (K = 8)', knn_8),
                      ('K Nearest Neighbors (K = 9)', knn_9),
                      ('K Nearest Neighbors (K = 10)', knn_10)]:
