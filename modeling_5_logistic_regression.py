...
def model(features, labels):
    ...
    """ Modeling """
    # Name and fit models 
    lgr_05 = LogisticRegression(C=0.5)
    lgr_1 = LogisticRegression(C=1.0)
    lgr_2 = LogisticRegression(C=2.0)
    
    # Print classification report and average of fold scores
    scores = []
    for name, clf in [('Logistic Regression (C = 0.5)', lgr_05),
                      ('Logistic Regression (C = 1.0)', lgr_1),
                      ('Logistic Regression (C = 2.0)', lgr_2)]:
