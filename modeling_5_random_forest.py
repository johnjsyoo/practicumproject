...
def model(features, labels):
    ...
    """ Modeling """
    # Name and fit models 
    rnf_auto = RandomForestClassifier(max_features='auto', n_estimators=100)
#    rnf_5 = RandomForestClassifier(max_features=0.05, n_estimators=100)
    rnf_10 = RandomForestClassifier(max_features=0.10, n_estimators=100)
    rnf_25 = RandomForestClassifier(max_features=0.25, n_estimators=100)
#    rnf_50 = RandomForestClassifier(max_features=0.50, n_estimators=100)
    
    # Print classification report and average of fold scores
    scores = []
    for name, clf in [('Random Forest (m = auto)', rnf_auto),
#                      ('Random Forest (m = 0.05)', rnf_5),
                      ('Random Forest (m = 0.10)', rnf_10),
                      ('Random Forest (m = 0.25)', rnf_25)]:
#                      ('Random Forest (m = 0.50)', rnf_50)]:
