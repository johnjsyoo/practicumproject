...
def model(features, labels):
    ...
    ada_200 = AdaBoostClassifier(n_estimators=200)
    ada_400 = AdaBoostClassifier(n_estimators=400)
    # Print classification report and average of fold scores
    scores = []
    for name, clf in [('ADA Boost (estimators = 50)', ada_50),
                      ('ADA Boost (estimators = 200)', ada_200),
                      ('ADA Boost (estimators = 400)', ada_400)]:
