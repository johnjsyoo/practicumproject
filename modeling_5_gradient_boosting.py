...
def model(features, labels):
    ...
    """ Modeling """
    # Name and fit models 
    gbc_3 = GradientBoostingClassifier(max_depth=3)
    gbc_5 = GradientBoostingClassifier(max_depth=5)
    gbc_7 = GradientBoostingClassifier(max_depth=7)
    gbc_10 = GradientBoostingClassifier(max_depth=10)
    gbc_15 = GradientBoostingClassifier(max_depth=15)
    
    # Print classification report and average of fold scores
    scores = []
    for name, clf in [('Gradient Boosting (max depth = 3)', gbc_3),
                      ('Gradient Boosting (max depth = 5)', gbc_5),
                      ('Gradient Boosting (max depth = 7)', gbc_7),
                      ('Gradient Boosting (max depth = 10)', gbc_10),
                      ('Gradient Boosting (max depth = 15)', gbc_15)]:
